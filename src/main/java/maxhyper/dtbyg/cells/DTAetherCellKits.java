...
//
//    public static final CellKit PALM = new CellKit(new ResourceLocation(DynamicTreesAether.MOD_ID, "palm")) {
//
...
//    };
//
//    public static final CellKit SPARSE = new CellKit(new ResourceLocation(DynamicTreesAether.MOD_ID, "sparse")) {
//
...
//        @Override
//        public SimpleVoxmap getLeafCluster() {
//            return DTAetherLeafClusters.SPARSE;
//        }
//
//        @Override
//        public CellSolver getCellSolver() {
...
//    };
//
//    public static final CellKit POPLAR = new CellKit(new ResourceLocation(DynamicTreesAether.MOD_ID, "poplar")) {
//
...
//        @Override
//        public SimpleVoxmap getLeafCluster() {
//            return DTAetherLeafClusters.POPLAR;
//        }
//
//        @Override
//        public CellSolver getCellSolver() {
...
//    };
//
//    public static final CellKit SMALL_DECIDUOUS = new CellKit(new ResourceLocation(DynamicTreesAether.MOD_ID, "small_deciduous")) {
//
...
//    public static final CellKit WILLOW = new CellKit(DynamicTreesAether.location("willow")) {
//
...
//        @Override
//        public SimpleVoxmap getLeafCluster() {
//            return DTAetherLeafClusters.WILLOW;
//        }
//
//        @Override
//        public int getDefaultHydration() {
...
//    };
//
//    public static final CellKit ROUND_CONIFER = new CellKit(DynamicTreesAether.location("round_conifer")) {
//
...
//        @Override
//        public SimpleVoxmap getLeafCluster() {
//            return DTAetherLeafClusters.ROUND_CONIFER;
//        }
//
//        @Override
//        public CellSolver getCellSolver() {
...
//    };
//
//    public static final CellKit BUSHY = new CellKit(DynamicTreesAether.location("bushy")) {
//
...
//        @Override
//        public SimpleVoxmap getLeafCluster() {
//            return DTAetherLeafClusters.BUSHY;
//        }
//
//        @Override
//        public CellSolver getCellSolver() {
...
//    };
//
//    public static final CellKit SYTHIAN_FUNGUS = new CellKit(DynamicTreesAether.location("sythian_fungus")) {
//
...
//        @Override
//        public SimpleVoxmap getLeafCluster() {
//            return DTAetherLeafClusters.SYTHIAN_FUNGUS;
//        }
//
//        @Override
//        public CellSolver getCellSolver() {
...
//    };
//
//    public static final CellKit LAMENT = new CellKit(DynamicTreesAether.location("lament")) {
//
...
//        @Override
//        public SimpleVoxmap getLeafCluster() {
//            return DTAetherLeafClusters.LAMENT;
//        }
//
//        @Override
//        public CellSolver getCellSolver() {
...
//    };
//
//    public static final CellKit SKYRIS = new CellKit(DynamicTreesAether.location("skyris")) {
