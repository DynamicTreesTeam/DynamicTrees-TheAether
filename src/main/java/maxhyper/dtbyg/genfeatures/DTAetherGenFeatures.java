...
import maxhyper.dtbyg.DynamicTreesAether;
...
//    public static final GenFeature EXTRA_BOTTOM_FLARE = new ExtraBottomFlareGenFeature(DynamicTreesAether.location("extra_bottom_flare"));
//    //public static final GenFeature MANGROVELINGS = new MangrovelingsGenFeature(DynamicTreesBYG.location("mangrovelings"));
//    public static final GenFeature BRANCH_SPROUTS = new BranchSproutsGenFeature(DynamicTreesAether.location("branch_sprouts"));
//    //public static final GenFeature HUGE_MUSHROOMS = new BYGHugeMushroomGenFeature(DynamicTreesBYG.location("huge_mushrooms"));
//    public static final GenFeature BIOME_PREDICATE_2 = new BiomePredicateGenFeature(DynamicTreesAether.location("biome_predicate"));
//    public static final GenFeature SYTHIAN_TOPPER = new SythianTopperGenFeature(DynamicTreesAether.location("sythian_topper"));
//    public static final GenFeature ALTERNATIVE_BRANCH = new AlternativeBranchGenFeature(DynamicTreesAether.location("alt_branch"));
//    public static final GenFeature MUSHROOM_VINES = new MushroomVinesGenFeature(DynamicTreesAether.location("mushroom_vines"));
